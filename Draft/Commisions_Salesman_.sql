...
T0.DocDate >=CONVERT(DATETIME, '20220101', 112) AND 
T0.DocDate <=CONVERT(DATETIME, '20220131', 112) AND
T0.Canceled='N'		AND 
T1.InvType=13		AND	
T2.DocType <> 'S'	AND 
T2.DocStatus='C'	AND 		
...
WHERE 
T4.DocDate >=CONVERT(DATETIME, '20220101', 112)	AND	T4.DocDate <=CONVERT(DATETIME, '20220131', 112)	AND
...
T2.CANCELED='N'		AND
TA.PaymentDate >=CONVERT(DATETIME, '20220101', 112)		AND TA.PaymentDate <=CONVERT(DATETIME, '20220131', 112)	AND		
T2.DocType <> 'S'	AND T2.DocStatus='C'	
AND T2.SlpCode=7
