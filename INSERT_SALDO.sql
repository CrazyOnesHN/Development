...
/****** Object: SqlProcedure [ASHPF].[sP_INSERT_SALDO] Script Date: 6/11/2017 7:24:29 a. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN 
	...
	BEGIN TRY
		BEGIN TRANSACTION;
				...
				TIPO,FECHA_PERIODO,CreatedBy,UpdatedBy)
									...
									M1.NIT, 
									M1.CONTABILIDAD,
									([PRUEBA].[ASHPF].[GET_TIPOSALDO] (M1.ASIENTO,M1.CENTRO_COSTO,M1.CUENTA_CONTABLE)) AS TIPO, 
									(SELECT MIN(P.FECHA_FINAL) FROM ASHPF.PERIODO_CONTABLE AS P 
									WHERE P.FECHA_FINAL >= M1.FECHA) AS FECHA_PERIODO, 
									M1.CreatedBy, 
									M1.UpdatedBy

									FROM PRUEBA.ASHPF.MAYOR AS M1
													...
													ORDER BY FECHA
														...
														IF @TEMP_TIPO	=	'C'
															...
															BEGIN
																...
																INSERT INTO PRUEBA.ASHPF.SALDO
	...
	BEGIN CATCH
		...
		END
			...
			EXECUTE PRUEBA.ASHPF.Sp_LogError;
	END CATCH;
END
